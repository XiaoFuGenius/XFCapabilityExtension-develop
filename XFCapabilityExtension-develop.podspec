...
Pod::Spec.new do |s|
  s.name         = "XFCapabilityExtension-develop" 		# 项目名称
  s.version      = "1.0.1" 		# 版本号 与 你仓库的 标签号 对应
  s.license      = "MIT" 	 # 开源证书
  s.summary      = "iOS 小肤能力扩展开发工具包 XFCapabilityExtension.framework Develop." 	# 项目简介
  s.deprecated = false

  s.homepage     = "https://github.com/XiaoFuGenius/XFCapabilityExtension-develop" 	# 你的主页
  s.source       = { :git => "https://github.com/XiaoFuGenius/XFCapabilityExtension-develop.git", :tag => "#{s.version}" } 	# 你的仓库地址
  s.requires_arc = true 	# 是否启用ARC
  s.platform     = :ios, "10.0" 		#平台及支持的最低版本
  s.vendored_frameworks = "Frameworks/XFCapabilityExtension.framework" 	#第三方库依赖
